...
public enum Mensaje {
    ...
    public static Mensaje getMensaje(String mensaje) {  
        ...
        } else if (mensaje.equals(PREFIJO + "REGISTRO_AGREGADO")){
            return REGISTRO_AGREGADO;
        } else if (mensaje.equals(PREFIJO + "REGISTRO_ELIMINADO")){
            return REGISTRO_ELIMINADO;
        } else if (mensaje.equals(PREFIJO + "REGISTRO_MODIFICADO")){
            return REGISTRO_MODIFICADO;
        } else if (mensaje.equals(PREFIJO + "DESCONECTAR")){
            return DESCONECTAR;
        } else if (mensaje.equals(PREFIJO + "DETENER_SERVICIO")){
            return DETENER_SERVICIO;
        } else if (mensaje.equals(PREFIJO + "ECO")){
            return ECO;
        } else if (mensaje.equals(PREFIJO + "GUARDA")){
            return GUARDA;
        } else {
            return INVALIDO;
        }
