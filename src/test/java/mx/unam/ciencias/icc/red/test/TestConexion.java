...
public class TestConexion {
    ...
    @Test public void testRecibeMensajes() {
        ...
        try {
            ...
            Conexion<Cliente> conexion =
                new Conexion<Cliente>(bdd, enchufe);
    ...
    @Test public void testRecibeRegistro() {
        try {
            ...
            Cliente c = TestCliente.clienteAleatorio(12345678);
            out.write(c.seria());
            out.flush();
            UtilRed.espera(10);

            Cliente f = conexion.recibeRegistro();
            Assert.assertTrue(c != f);
    ...
    @Test public void testEnviaRegistro() {
        try {
            ...
            Cliente c = TestCliente.clienteAleatorio(12345678);
            conexion.enviaRegistro(c);
            UtilRed.espera(10);

            String linea = in.readLine();
            Assert.assertTrue(c.seria().equals(linea + "\n"));
        } catch (IOException ioe) {
            Assert.fail();
        }
    }
    ...
    @Test public void testGetSerie() {
        try {
            ...
            for (int i = 0; i < total; i++) {
                ...
                conexion = new Conexion<Cliente>(bdd, enchufe);
